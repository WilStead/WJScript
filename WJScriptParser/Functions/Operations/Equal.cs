...
namespace WScriptParser.Functions.Operations
{
    ...
    {
        public string Name => Constants.EQUAL;
        ...
        public Variable Combine(Variable left, Variable right)
        {
            switch (left.Type)
            {
                case Variable.VariableType.Array:
                    switch (right.Type)
                    {
                        // array == array compares keys and values, not reference
                        case Variable.VariableType.Array:
                        ...
                        // array == boolean is true if the boolean is true and the array is non-empty, or the boolean is false and the array is empty
                        ...
                        // array != string compares length if the string is a number, and is false otherwise
                ...
                case Variable.VariableType.String:
                    switch (right.Type)
                    {
                        // string != array compares length if the string is a number, and is false otherwise
                        case Variable.VariableType.Array:

...
namespace WScriptParser.Functions.Operations
{
    ...
    {
        public string Name => Constants.GREATER_THAN;
            ...
            switch (left.Type)
            {
                case Variable.VariableType.Array:
                    switch (right.Type)
                    {
                        ...
                        // array > boolean is true if the array is non-empty and the boolean is false; otherwise false
                ...
                case Variable.VariableType.Boolean:
                    switch (right.Type)
                    {
                        // boolean > array is true if the boolean is true and array is empty
                        case Variable.VariableType.Array:
                            return new Variable(left.Boolean && right.Children.Count == 0);
                        // boolean > boolean is true if the left is true and the right is false
                        case Variable.VariableType.Boolean:

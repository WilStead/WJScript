...
namespace WScriptParser.Functions.Operations
{
    ...
    {
        public string Name => Constants.LESS_THAN;
            ...
            switch (left.Type)
            {
                case Variable.VariableType.Array:
                    switch (right.Type)
                    {
                        ...
                        // array < boolean is true if the array is empty and the boolean is true; otherwise false
                ...
                case Variable.VariableType.Boolean:
                    switch (right.Type)
                    {
                        // boolean < array is true if the array is non-empty and the boolean is false
                        case Variable.VariableType.Array:
                            return new Variable(!left.Boolean && right.Children.Count > 0);
                        // boolean < boolean is true if the left is false and the right is true
                        case Variable.VariableType.Boolean:
